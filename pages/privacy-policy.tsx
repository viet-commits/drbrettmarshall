...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <div className="bg-gray-50 border-b"><div className="max-w-[1200px] mx-auto px-4 py-8"><h1 className="text-2xl font-light text-[#1a3a4a]">Privacy Policy</h1><div className="text-xs text-gray-400 mt-1"><a href="/" className="hover:text-[#1a3a4a]">Home</a> / Privacy Policy</div></div></div>
      <div className="max-w-[1200px] mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2"><div className="text-sm leading-relaxed text-gray-600 space-y-4">
            ...
            <h2 className="text-lg font-semibold text-[#1a3a4a] !mt-8">Collection of Information</h2>
            ...
            <h2 className="text-lg font-semibold text-[#1a3a4a] !mt-8">Use and Disclosure</h2>
            ...
            <h2 className="text-lg font-semibold text-[#1a3a4a] !mt-8">Data Security</h2>
            ...
            <h2 className="text-lg font-semibold text-[#1a3a4a] !mt-8">Access and Correction</h2>
            ...
            <h2 className="text-lg font-semibold text-[#1a3a4a] !mt-8">Contact</h2>
