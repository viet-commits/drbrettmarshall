...
interface ServiceData { title: string; content: string; meta: string; }
    ...
    <>
      ...
      <div className="max-w-[1200px] mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {display.map((svc) => (
            <a key={svc.slug} href={`/services/${svc.slug}`} className="block bg-white border border-gray-200 shadow-sm rounded-sm p-6 hover:shadow-md hover:border-[#253d47]/30 transition-all group">
              <h3 className="font-semibold text-[#253d47] text-lg mb-3 group-hover:underline">{svc.title}</h3>
