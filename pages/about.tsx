    ...
    <>
      ...
      <div className="bg-gray-50 border-b">
        <div className="max-w-[1200px] mx-auto px-4 py-8">
          <h1 className="text-2xl font-light text-[#1a3a4a]">About</h1>
          <div className="text-xs text-gray-400 mt-1">
            <a href="/" className="hover:text-[#1a3a4a]">Home</a> / About
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-10 mb-16">
          <div className="md:w-1/3 flex-shrink-0">
            ...
            <div className="mt-6">
              <a
                href="/contact"
                className="block w-full text-center bg-[#1a3a4a] text-white px-6 py-3 rounded-sm font-semibold text-sm uppercase tracking-wider hover:bg-[#2a4a5a] transition-colors"
              >
                CONTACT
              </a>
            </div>
          ...
          <div className="md:w-2/3">
            <h2 className="text-2xl font-light text-[#1a3a4a] mb-6">Dr Brett Marshall</h2>
            <div className="w-10 h-px bg-[#1a3a4a] mb-6" />
            ...
            <div className="text-sm leading-relaxed text-gray-600 space-y-4">
              ...
              <p>
                ...
                <a href="/services/laparoscopic-surgery" className="text-[#1a3a4a] hover:underline">advanced laparoscopic surgery</a>{" "}
              ...
              <p>
                ...
                <a href="/services/advanced-hysteroscopic-surgery" className="text-[#1a3a4a] hover:underline">hysteroscopy surgery</a>
                , treating heavy menstrual bleeding, fibroids and polyps, and was one of the first gynaecologists to perform{" "}
                <a href="/services/endometrial-ablation" className="text-[#1a3a4a] hover:underline">endometrial ablation / resection</a>{" "}
                in Australia.
              </p>
              <p>
